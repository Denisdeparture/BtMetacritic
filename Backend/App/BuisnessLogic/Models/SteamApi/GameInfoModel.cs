...
namespace BuisnessLogic.Models.SteamApi;
...
public class Movie
{
    ...
    public string dash_av1 { get; set; }
    public string dash_h264 { get; set; }
    public string hls_h264 { get; set; }
...
{
    public GameInfoModel data { get; set; }
