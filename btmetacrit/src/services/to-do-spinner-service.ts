import { ApplicationRef, ComponentRef,  inject, Injectable, Injector, 
    ViewContainerRef } from "@angular/core";
import { KindOfSpinner, ToDoSpinner } from "../components/common/to-do-spinner/to-do-spinner";
...
export class ToDoSpinnerService {
  ...
  showSpinner(color: string, kind: KindOfSpinner,  data?: any): ToDoSpinner{
    ...
    const componentRef = this.componentFactory.createComponent(ToDoSpinner,{ injector: this.injector } );
